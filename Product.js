...
var modeldata=[
 ...
 "https://lp2.hm.com/hmgoepprod?set=source[/2d/5b/2d5bb41ca23e6792ba9b5089c3e8aaeb00c9e8b1.jpg],origin[dam],category[kids_boys14y_jumperscardigans],type[DESCRIPTIVESTILLLIFE],res[z],hmver[2]&call=url[file:/product/main]",
  ...
  { price:"1,399",
    ...
    type: "OverSized cotto shirt Jacket",
    image_url:
      "https://lp2.hm.com/hmgoepprod?set=quality%5B79%5D%2Csource%5B%2Ff7%2F7e%2Ff77e85c3a595e3bb610ca38f8a8f7d7023a3f86d.jpg%5D%2Corigin%5Bdam%5D%2Ccategory%5B%5D%2Ctype%5BLOOKBOOK%5D%2Cres%5Bm%5D%2Chmver%5B1%5D&call=url[file:/product/main]",
  },
  { price:"1,499",
    MRP: 1499,
    new: 10,
...
function handlebyprice(){
    var select=document.getElementById("sortbyprice").value;
console.log(select);
...
div.textContent="SHOWING 14 of 14 Items"
div.setAttribute("id","showingss")
right.append(div)
...
div2.textContent=""
div2.setAttribute("id","showingsmall")
